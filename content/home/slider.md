...
[[item]]
  ...
  content = "Our precision weeders at the 2026 Midwest Physical Weed Control Field Day (Benton Harbor, MI)"
  align = "center"
...
[[item]]
  ...
  # overlay_color = "#FFFF00"  # An HTML color value.
  overlay_img = "2026ASABEAIMAwards.jpg"  # Image path relative to your `static/media/` folder.
  overlay_filter = 0.1  # Darken the image. Value in range 0-1.
  
 [[item]]
  # title = "InfieldWeedingDemo"
  content = "2025 Precision Weeding Demo at the MSU HTRC"
  align = "center"
...
[[item]]
  ...
  # overlay_color = "#FFFF00"  # An HTML color value.
  overlay_img = "OpticalSensing.png"  # Image path relative to your `static/media/` folder.
  overlay_filter = 0.1  # Darken the image. Value in range 0-1.
